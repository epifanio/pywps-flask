...
Author: Eivind Stoylen (eivinds@met.no)
...
#        self.testoutput.setValue(self.inputfile.getValue())
        ...
        logging.debug("HELLOWORLD execute!")
...
#Create output
	...
	sizecom = inCommand[:] #For file size testing
        ...
        inCommand.append("--output.type="+inType)
	    ...
	    try:
		    ...
		    continue
           	self.status.set('{}'.format(err.output,))
            	...
            	self.urlout.setValue("http://157.249.176.177"+output_filename[13:])
